...
const ScoutingMethods: NextPage<PropsData> = (props: PropsData) => {
    ...
    return <>
        <section className={styles.title} onClick={() => console.log("cclicked")}>
            <div onClick={() => {console.log("hi"); props.setPage("Sushi Scouts");}}><svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.back}>
